...
## SSH removido: repositório público usa HTTPS. Nenhuma configuração SSH necessária.
    # Locais (globais) IPv6
...
clone_repository() {
    ...
    # Repositório público: sempre usar HTTPS
...
case "$1" in
    ...
    update)
        ...
        # Garantir remoto HTTPS (repositório público)
